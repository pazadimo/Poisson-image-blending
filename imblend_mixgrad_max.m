function  output = imblend_mixgrad_max( source, mask, target, transparent )
...
%fuckred = (bred+ bred2) /2;
% bred= max(abs(fuckred),[],2);
...
%fuckgreen = (bgreen + bgreen2)/2;
% bgreen= max(abs(fuckgreen),[],2);
